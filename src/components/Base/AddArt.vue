    ...
    <div class="form">
        ...
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="150" :inline="true">
            ...
            <FormItem label="艺术家头像" prop="imageUrl" class="formItem100">
                <EyUpload @upload-ok="getImgUrl" @upload-error="uploadError" @upload-exceeded-size="uploadExceededSize" :maxSize="50" accept="image/jpeg,image/jpg,image/png"  imgSizeText="图片规格：高100px,宽100px，不超过50K" />
                <p v-show="isUploadOk">
                    <span class="headImg">
...
<script>
import { Breadcrumb, BreadcrumbItem, Button, Form, FormItem, Input, Option, Row, Col, Icon,RadioGroup,Radio,Tag,Select } from 'iview';
...
export default {
    name: 'AddArt',
    components: { Breadcrumb, BreadcrumbItem, Button, Form, FormItem, Input, Option, Row, Col, Icon,EyQuill,EyUpload,RadioGroup,Radio,Tag,Select },
    data() {
        return {
            isUploadOk: false,
            editFormValidate: [],
    ...
    created() {
        ...
        if(this.$route.params.data!==undefined && this.$route.params.data.artistDto){
