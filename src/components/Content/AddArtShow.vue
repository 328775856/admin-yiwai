  ...
  <div class="addArtShow">
    ...
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="150">
      ...
      <div v-show="show">
        <div v-show=" exhibitionTicketsShow">
          ...
          <FormItem label="展期" prop="exhibitionTicketsInfoDate" class="formItem45">
            <DatePicker :value="formValidate.exhibitionTicketsInfoDate" format="yyyy/MM/dd" type="daterange" placeholder="选择展期" style="width: 230px" ref="data2" @on-clear="_onClear" @on-change="_onChange"></DatePicker>
          </FormItem>
      ...
      <Button style="margin-left: 150px " class="addTicket" type="primary" v-show="!exhibitionTicketsShow" @click="addNew">新增展券</Button>
        <Button style="margin-left: 150px " class="addTicket" type="warning" v-show=" exhibitionTicketsShow && deleteShow" @click="exhibitionTicketsDelete">删除展券</Button>
  ...
  export default {
    ...
    created() {
      ...
      if (data) {
        ...
        this.exhibitionTicketsShow = false
    ...
    methods: {
      ...
      _onChange() {
        ...
        this.formValidate.exhibitionTicketsInfoDate[0] = util.getNowFormatDate(
          this.$refs.data2.internalValue[0]
        ) //开始时间
        this.formValidate.exhibitionTicketsInfoDate[1] = util.getNowFormatDate(
      ...
      addNew(){
        ...
        this.show = true
        this.ruleValidate.discount[0].required = true
        this.ruleValidate.exhibitionTicketsInfoDate[0].required = true
      }
    }
  }
</script>
