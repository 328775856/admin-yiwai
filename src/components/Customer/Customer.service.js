...
const setCustomerType = data => request.post('setCustomerType/v1', data);

export {getCustomerList, getCustomerInfo, setCustomer, setVip, deleteCustomer, setCustomerType};
