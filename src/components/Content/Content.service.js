...
const getHomePageStatisticsList = data => request.post('getHomePageStatisticsList/v1', data);
const deleteHomePageChoiceness = data => request.post('deleteHomePageChoiceness/v1', data);
const setHomePageChoiceness = data => request.post('setHomePageChoiceness/v1', data);
...
export { getArticleList, setArticle, deleteArticle, getHomePageStatisticsList, deleteHomePageChoiceness, setHomePageChoiceness, getCommentInfo, setExhibition, deleteExhibition, getExhibitionList,setExhibits,findByExhibitionId,deleteExhibits };
